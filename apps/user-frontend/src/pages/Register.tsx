...
import { Spade, Mail, Lock, User, ArrowRight, Gift, Coins } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      ...
      <div
        ...
        style={{
          background: `
            radial-gradient(ellipse at 80% 20%, hsl(43 96% 56% / 0.03) 0%, transparent 50%),
            radial-gradient(ellipse at 20% 80%, hsl(345 45% 30% / 0.05) 0%, transparent 50%)
          `,
        }}
      />
